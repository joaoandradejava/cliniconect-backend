...
insert into endereco(cep ,rua, bairro, cidade, estado, numero, pessoa_id) values
('53333333', 'Rua Vinte e um de novembro', 'Genibáu', 'Fortaleza', 'CE', '330', 1),
('53333333' ,'Rua Vitorino Carmilo', 'Barra Funda', 'São Paulo', 'SP', '320', 2);